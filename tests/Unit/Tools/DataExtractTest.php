...
test('it accepts schema with nested properties', function () {
    ...
    // Execute should work with mock provider
    $result = $tool->execute([
...
test('it uses default instructions when not provided', function () {
    ...
    // Should use default instructions and succeed with mock
    $result = $tool->execute([
        'text' => 'Test content',
...
test('it accepts custom instructions parameter', function () {
    ...
    // Should accept custom instructions and succeed with mock
    $result = $tool->execute([
        'text' => 'Test content',
        'schema' => ['type' => 'object', 'properties' => ['data' => ['type' => 'string']]],
...
test('it has configurable model', function () {
    $tool = new DataExtract(mockProvider(), model: 'gpt-4o');
