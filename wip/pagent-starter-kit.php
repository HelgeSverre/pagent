...
namespace Pagent\Core {
    ...
    class Agent
    {
        ...
        public function prompt(string $message): object
        {
            ...
            return (object)[
                ...
                'usage' => ['tokens' => strlen($message) + strlen($response)]
            ];
        }
    ...
    class AgentBuilder
    {
        ...
        public function register(): void
        {
            ...
            Registry::addAgent($this->name, function() use ($config) {
...
namespace {
    ...
    use Pagent\Core\{Registry, AgentBuilder, Expectation};
...
it('responds professionally to greetings', function () {
...
it('stays within role boundaries', function () {
...
it('maintains context in conversation', function () {
