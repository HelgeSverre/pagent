...
it('responds politely to greetings', function ($agent) {
    $response = $agent->prompt('hello');
    expect($response)->toContain('Hello');
});

it('handles refund requests', function ($agent) {
...
class Evaluator
{
    ...
    {
        return [
            'similarity' => similar_text($actual, $expected) / max(strlen($actual), strlen($expected)),
