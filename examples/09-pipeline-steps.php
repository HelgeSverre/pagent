...
$validator = mock([
    '{"invoice_number":"INV-2025-001","amount":"2500","due_date":"2025-02-15","urgent":true}' => '{"valid": true, "errors": [], "warnings": ["Amount is above $1000 threshold"]}',
]);

$formatter = mock([
    '{"valid":true,"errors":[],"warnings":["Amount is above $1000 threshold"]}' => 'Invoice INV-2025-001: $2,500.00 due 2025-02-15 [URGENT]',
]);
