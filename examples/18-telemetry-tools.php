...
echo "\n[Telemetry: Tool Execution Tracking]\n";
...
echo "Input: Check if composer.json exists and tell me its size\n";
...
echo "Input: Analyze this text and extract numbers: '{$text}'\n";
...
echo "Input: Get user 42 and their posts\n";
...
echo "Input: Execute the workflow: fetch, process, and validate\n";
