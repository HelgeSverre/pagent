...
final class TestRepository
{
    ...
    public static function add(string $description, \Closure $closure, array $modifiers = []): void
    {
        self::$tests[] = [
...
final class DynamicTestCase extends \PHPUnit\Framework\TestCase
{
...
final class WebSearch extends Tool
{
...
it('handles refunds appropriately', function (): void {
